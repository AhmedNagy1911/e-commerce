...
public class PaymentService(IConfiguration config, ICartService cartService,IGenericRepository<Core.Entites.Product> productRepo,IGenericRepository<DeliveryMethod> dmRepo) : IPaymentService
{
